# Olá! 👋 Sou a Stephany Almeida

Sou Desenvolvedora Full Stack com 3 anos de experiência, focada em construir sistemas robustos e interfaces dinâmicas. Gosto de resolver problemas complexos e arquitetar soluções eficientes, transitando entre o back-end e o front-end.

### 💻 O que eu faço
- 🏢 Atualmente desenvolvendo sistemas de gestão (com foco em arquiteturas MVC e Minimal APIs) utilizando o ecossistema **.NET**.
- 🌐 Criando interfaces interativas e tipadas com **React** e **TypeScript**.
- 📍 Trabalhando de São José do Rio Preto, SP.
- 🎮 Nas horas vagas, provavelmente estou assistindo algum anime, jogando Fortnite ou brincando com mods para o The Sims 4!
